...
def generate_lesson_evaluation_with_gemini(client, topic, syllabus_code):
    ...
    # Universal, subject-agnostic fallback sentences if the API completely fails
    ...
    for attempt in range(max_retries):
        try:
            ...
            # Enforce structured output from Google's platform directly
            ...
            # Clean string boundaries from markdown symbols
